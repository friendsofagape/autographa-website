...
function fetcher<TData, TVariables>(query: string, variables?: TVariables) {
  return async (): Promise<TData> => {
    ...
    method: "POST",
    ...({"headers":{"Authorization":"Bearer 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"}}),
...
export type GetDownloadUrlQueryVariables = Exact<{ [key: string]: never; }>;


export type GetDownloadUrlQuery = { __typename?: 'Query', repository?: { __typename?: 'Repository', releases: { __typename?: 'ReleaseConnection', nodes?: Array<{ __typename?: 'Release', name?: string | null, tagName: string, isLatest: boolean, releaseAssets: { __typename?: 'ReleaseAssetConnection', edges?: Array<{ __typename?: 'ReleaseAssetEdge', node?: { __typename?: 'ReleaseAsset', name: string, downloadUrl: any, contentType: string, size: number, createdAt: any } | null } | null> | null } } | null> | null } } | null };
...
export const GetDownloadUrlDocument = `
  ...
  repository(owner: "friendsofagape", name: "autographa") {
    ...
    `;
export const useGetDownloadUrlQuery = <
      TData = GetDownloadUrlQuery,
      TError = unknown
    >(
      variables?: GetDownloadUrlQueryVariables,
      options?: UseQueryOptions<GetDownloadUrlQuery, TError, TData>
    ) =>
    useQuery<GetDownloadUrlQuery, TError, TData>(
      variables === undefined ? ['getDownloadURL'] : ['getDownloadURL', variables],
      fetcher<GetDownloadUrlQuery, GetDownloadUrlQueryVariables>(GetDownloadUrlDocument, variables),
      options
    );